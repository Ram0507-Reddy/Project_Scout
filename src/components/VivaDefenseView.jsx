  ...
  if (!repoData) {
    return (
      <div className="p-10 rounded-3xl bg-white border border-zinc-200 text-center space-y-4 shadow-sm flex flex-col items-center justify-center min-h-[300px]">
        <h3 className="text-base font-extrabold text-zinc-900">Viva Simulator Offline</h3>
        <p className="text-xs text-zinc-500 max-w-md mx-auto">
          Connect your GitHub repository to generate a realistic viva defense simulation.
        </p>
        <button
    ...
    return (
      <div className="p-10 rounded-3xl bg-white border border-zinc-200 text-center space-y-4 shadow-sm">
        ...
        <h3 className="text-lg font-black text-zinc-900">
          "Will this actually pass a viva examination?"
        </h3>
        <p className="text-xs text-zinc-500 max-w-lg mx-auto">
          External examiners look for research gaps, flawed methodologies, and unaddressed edge cases. 
          Generate tough, repository-grounded viva defense questions with model responses.
        </p>
        <button
        ...
        >
          ...
          <span>Generate Viva Defense Simulation</span>
        </button>
      </div>
    );
  }
    ...
    return (
      <div className="p-12 rounded-3xl bg-white border border-zinc-200 text-center space-y-4 shadow-sm">
        ...
        <h3 className="text-base font-bold text-zinc-900">
          Simulating External Viva Committee...
        </h3>
        <p className="text-xs text-zinc-500 max-w-md mx-auto">
          Scanning your codebase, dependencies, and README for architectural blindspots and unverified claims...
        </p>
      </div>
    );
  }
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs px-2.5 py-0.5 rounded-full bg-zinc-100 text-zinc-700 font-semibold">
                Simulated External Committee
              </span>
            </div>
            <p className="text-xs text-zinc-500 mt-0.5">
              {vivaReadinessScore >= 75 ? 'You are well prepared, but be ready for specific baseline comparison queries.' : 'High risk of examiner pushback on methodology and documentation.'}
            </p>
          </div>
        </div>
